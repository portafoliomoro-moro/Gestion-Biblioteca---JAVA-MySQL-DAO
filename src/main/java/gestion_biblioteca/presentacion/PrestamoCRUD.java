...
import gestion_biblioteca.datos.IPrestamoDAO;
import gestion_biblioteca.datos.PrestamoDAO;
...
public class PrestamoCRUD {
    public static void prestamoApp(){
        var salir = false;
    ...
    private static boolean ejecutarOpcion(int opcion, Scanner consola, IPrestamoDAO prestamoDAO){
        ...
        switch(opcion){
            ...
            case 2 -> {
                ...
                System.out.print("Id préstamo a buscar: ");
