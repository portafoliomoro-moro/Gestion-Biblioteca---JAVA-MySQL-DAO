...
import gestion_biblioteca.datos.ILibroDAO;
import gestion_biblioteca.datos.LibroDAO;
import gestion_biblioteca.dominio.EstadoLibro;
import gestion_biblioteca.dominio.Libro;

import java.util.Scanner;

public class LibrosCRUD {
    public static void libroApp(){
        var salir = false;
